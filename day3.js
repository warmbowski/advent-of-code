//*** Day 3 Exercise 1 ***
var housesVisitedBySanta = function(directions) {
  var coord = [0, 0];
  var houses = {'0:0': 1};
  ...
  for (var i=0; i < directions.length; i+=1) {
    ...
    if (typeof houses[coord[0] + ':' + coord[1]] === 'undefined') {
      houses[coord[0] + ':' + coord[1]] = 0;
    }
    houses[coord[0] + ':' + coord[1]] += 1;
  }
  return Object.keys(houses).length;
};

//*** Day 3 Exercise 2 ***
var housesVisitedBySantaAndRoboSanta = function(directions) {
  var coord = [ [0, 0], [0, 0] ];
  var houses = {'0:0': 2};
  ...
  for (var i=0; i < directions.length; i+=1) {
    ...
    if (typeof houses[coord[rem][0] + ':' + coord[rem][1]] === 'undefined') {
      houses[coord[rem][0] + ':' + coord[rem][1]] = 0;
    }
...
console.log('Santa:', housesVisitedBySanta(input), 'houses');
console.log('Santa and RoboSanta:', housesVisitedBySantaAndRoboSanta(input), 'houses');
